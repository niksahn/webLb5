...
public class CourseController {
    ...
    @CrossOrigin
    public ResponseEntity<?> addCourse(@RequestHeader("Authorization") Long session_id, @RequestBody @Valid AddCourseRequest request, BindingResult bindingResult) {
        var auth = checkAuth(session_id, sessionService);
    ...
    @CrossOrigin
    public ResponseEntity<?> editCourse(@RequestHeader("Authorization") Long session_id, @RequestParam Long id, @RequestBody  AddCourseRequest request ) {
        var auth = checkAuth(session_id, sessionService);
        if (auth != null) return auth;
//        var valid = validate(bindingResult);
//        if (valid != null) return valid;
